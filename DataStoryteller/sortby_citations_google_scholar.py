...
def update_citations(keyword_in, result_count_in, csv_path_in):
    # Update these variables according to your requirement
    keyword = keyword_in # the double quote will look for the exact keyword,
                                                # the simple quote will also look for similar keywords
    number_of_results = result_count_in # number of results to look for on Google Scholar
    save_database = True # choose if you would like to save the database to .csv
    path = csv_path_in # path to save the data
