...
% d cond (Conductivity at Dome Island). Chemical O at Site I
filename = 'C:\Users\Zev\Documents\GitHub\DataStoryteller\DataStoryteller\data\d_cond\d_cond_csv.csv';
...
title_text = 'Chemical O at Site I';
%title_text = 'Conductivity at Dome Island';
title(title_text)
