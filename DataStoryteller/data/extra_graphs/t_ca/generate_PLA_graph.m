...
% t ca (Calcium at Tea Island)
filename = 'C:\Users\Zev\Documents\GitHub\DataStoryteller\DataStoryteller\data\t_ca\t_ca_csv.csv';
...
title_text = 'Chemical E at Site K';
%title_text = 'Calcium Levels at Tea Island';
title(title_text)
